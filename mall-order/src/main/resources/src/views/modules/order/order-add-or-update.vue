    ...
    <el-dialog
        ...
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
            ...
            <el-form-item label="´ÙÏúÓÅ»¯½ð¶î£¨´ÙÏú¼Û¡¢Âú¼õ¡¢½×ÌÝ¼Û£©" prop="promotionAmount">
                <el-input v-model="dataForm.promotionAmount"
                          placeholder="´ÙÏúÓÅ»¯½ð¶î£¨´ÙÏú¼Û¡¢Âú¼õ¡¢½×ÌÝ¼Û£©"></el-input>
            </el-form-item>
            ...
            <el-form-item label="Ö§¸¶·½Ê½¡¾1->Ö§¸¶±¦£»2->Î¢ÐÅ£»3->ÒøÁª£» 4->»õµ½¸¶¿î£»¡¿" prop="payType">
                <el-input v-model="dataForm.payType"
                          placeholder="Ö§¸¶·½Ê½¡¾1->Ö§¸¶±¦£»2->Î¢ÐÅ£»3->ÒøÁª£» 4->»õµ½¸¶¿î£»¡¿"></el-input>
            </el-form-item>
            ...
            <el-form-item label="¶©µ¥×´Ì¬¡¾0->´ý¸¶¿î£»1->´ý·¢»õ£»2->ÒÑ·¢»õ£»3->ÒÑÍê³É£»4->ÒÑ¹Ø±Õ£»5->ÎÞÐ§¶©µ¥¡¿"
                          prop="status">
                <el-input v-model="dataForm.status"
                          placeholder="¶©µ¥×´Ì¬¡¾0->´ý¸¶¿î£»1->´ý·¢»õ£»2->ÒÑ·¢»õ£»3->ÒÑÍê³É£»4->ÒÑ¹Ø±Õ£»5->ÎÞÐ§¶©µ¥¡¿"></el-input>
            </el-form-item>
            ...
            <el-form-item label="·¢Æ±ÀàÐÍ[0->²»¿ª·¢Æ±£»1->µç×Ó·¢Æ±£»2->Ö½ÖÊ·¢Æ±]" prop="billType">
                <el-input v-model="dataForm.billType"
                          placeholder="·¢Æ±ÀàÐÍ[0->²»¿ª·¢Æ±£»1->µç×Ó·¢Æ±£»2->Ö½ÖÊ·¢Æ±]"></el-input>
            </el-form-item>
            ...
            return {
                ...
                dataRule: {
                    ...
                    payType: [
                        {
                            required: true,
                            message: 'Ö§¸¶·½Ê½¡¾1->Ö§¸¶±¦£»2->Î¢ÐÅ£»3->ÒøÁª£» 4->»õµ½¸¶¿î£»¡¿不能为空',
                            trigger: 'blur'
                        }
                    ],
                    sourceType: [
                    ...
                    status: [
                        {
                            required: true,
                            message: '¶©µ¥×´Ì¬¡¾0->´ý¸¶¿î£»1->´ý·¢»õ£»2->ÒÑ·¢»õ£»3->ÒÑÍê³É£»4->ÒÑ¹Ø±Õ£»5->ÎÞÐ§¶©µ¥¡¿不能为空',
                            trigger: 'blur'
                        }
                    ],
                    deliveryCompany: [
                    ...
                    billType: [
                        {
                            required: true,
                            message: '·¢Æ±ÀàÐÍ[0->²»¿ª·¢Æ±£»1->µç×Ó·¢Æ±£»2->Ö½ÖÊ·¢Æ±]不能为空',
                            trigger: 'blur'
                        }
                    ],
                    billHeader: [
