<template>
    <el-dialog
        ...
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
            ...
            <el-form-item label="¸Ä±äµÄÖµ£¨Õý¸º¼ÆÊý£©" prop="changeCount">
                <el-input v-model="dataForm.changeCount" placeholder="¸Ä±äµÄÖµ£¨Õý¸º¼ÆÊý£©"></el-input>
            </el-form-item>
            <el-form-item label="±¸×¢" prop="note">
                <el-input v-model="dataForm.note" placeholder="±¸×¢"></el-input>
            </el-form-item>
            <el-form-item label="»ý·ÖÀ´Ô´[0-¹ºÎï£¬1-¹ÜÀíÔ±ÐÞ¸Ä]" prop="sourceType">
                <el-input v-model="dataForm.sourceType" placeholder="»ý·ÖÀ´Ô´[0-¹ºÎï£¬1-¹ÜÀíÔ±ÐÞ¸Ä]"></el-input>
            </el-form-item>
        </el-form>
        ...
        data() {
            return {
                ...
                dataRule: {
                    ...
                    changeCount: [
                        {required: true, message: '¸Ä±äµÄÖµ£¨Õý¸º¼ÆÊý£©不能为空', trigger: 'blur'}
                    ],
                    note: [
                        {required: true, message: '±¸×¢不能为空', trigger: 'blur'}
                    ],
                    sourceType: [
                        {required: true, message: '»ý·ÖÀ´Ô´[0-¹ºÎï£¬1-¹ÜÀíÔ±ÐÞ¸Ä]不能为空', trigger: 'blur'}
                    ]
                }
            }
        },
